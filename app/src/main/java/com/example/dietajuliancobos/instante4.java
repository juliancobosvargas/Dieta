...
public class instante4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instante4);
    ...
    private void irDieta() {
        Intent intento = new Intent(this, Dieta1.class);
